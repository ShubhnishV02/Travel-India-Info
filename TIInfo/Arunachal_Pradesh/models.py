...
class ArunachalPradesh(models.Model):
    place_id = models.AutoField(primary_key=True)
    Image = models.ImageField(upload_to="Arunachal_Pradesh/images", default="")
