...
class WestBengal(models.Model):
    place_id = models.AutoField(primary_key=True)
    Image = models.ImageField(upload_to="West_Bengal/images", default="")
